...
from DynamicFleeDecision import DynamicFleeAction, DynamicFleeDecision
        ...
        # Experimento 2
            ...
            if exp2_pathfinding:
                ...
                if not pathfinding_active:
                    ...
                    dynamic_flee = DynamicFleeAction(enemy, (player_x, player_y), MAX_ACCELERATION, DETECTION_RADIUS, WORLD_WIDTH, WORLD_HEIGHT, EXP2_MIN_X, EXP2_MAX_X)                    
                    ...
                    # Árbol de decisión
                    decision_tree = DynamicFleeDecision(enemy, (player_x, player_y), player_is_attacking, EXP2_DETECTION_RADIUS, dynamic_flee, attack_action, patrol_action, EXP2_MIN_X, EXP2_MAX_X)
                    # Determinar acción
