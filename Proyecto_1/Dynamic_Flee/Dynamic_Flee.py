...
# Implementación del algoritmo Dynamic Flee
import pygame, sys
...
max_distance = 200
flee_behavior = DynamicFlee(cat, mouse, max_acceleration, max_distance,  Width, Height)
...
while True:
    ...
    # Calculamos la distancia entre el gato y el ratón
    distance = (cat.position - mouse.position).magnitude()

    # Actualizamos la posición y velocidad del gato solo si está dentro de la distancia máxima
